...
void RenderTarget::AttachTexture( AttachmentPoint attachmentPoint, const DX12Texture& texture )
{
...
const DX12Texture& RenderTarget::GetTexture( AttachmentPoint attachmentPoint ) const
{
...
const std::vector<DX12Texture>& RenderTarget::GetTextures() const
{
    return m_Textures;
}
