...
std::shared_ptr<DescriptorAllocatorPage> DX12DescriptorAllocator::CreateAllocatorPage()
{
...
DescriptorAllocation DX12DescriptorAllocator::Allocate(uint32_t numDescriptors)
{
